...
let level = 0;
let started = false;
$(".top-row").addClass("red");
$(".middle-row").addClass("green");
$(".bottom-row").addClass("blue");
//-----------------------------------------------------
...
function animatePressNextSequence(currentLetter) {
...
function nextSequence() {
    ...
    animatePressNextSequence(randomChosenLetter);

    playSound($("#" + randomChosenLetter).attr("class").split(/\s+/)[3]);
}
//-----------------------------------------------------
...
$(".btn").on("click", function() {
    ...
    playSound($(this).attr("class").split(/\s+/)[3]);
